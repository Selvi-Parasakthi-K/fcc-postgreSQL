...
ALTER SEQUENCE public.blackhole_balckhole_id_seq OWNED BY public.blackhole.balckhole_id;
...
--
-- Name: blackhole balckhole_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.blackhole ALTER COLUMN balckhole_id SET DEFAULT nextval('public.blackhole_balckhole_id_seq'::regclass);
...
INSERT INTO public.star VALUES (3, 123461234, 'yellow', 'gray', 1);
...
SELECT pg_catalog.setval('public.blackhole_balckhole_id_seq', 1, false);
...
ALTER TABLE ONLY public.blackhole
    ADD CONSTRAINT blackhole_pkey PRIMARY KEY (balckhole_id);
